        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="mt-16">
                ...
                <form id="app" method="post" action="{{ route('welcome') }}">
                    ...
                    <input type="text" name="listaPalabras" value="MANATI,PERRO,GATO,CONEJO,TIBURON,ELEFANTE,ALCON,SERPIENTE,JAGUAR,CANGURO,LOBO,MONO,NUTRIA,LEON,LORO,TORO,ORUGA" required>
                    <br>
                    <label for="matriz">Matriz (separada por comas):</label>
<textarea name="matriz" required rows="15" cols="50">N,D,E,K,I,C,A,N,G,U,R,O,G,E
...
N,N,X,H,E,B,P,M,U,P,E,R,R,O</textarea>
                    <br>
